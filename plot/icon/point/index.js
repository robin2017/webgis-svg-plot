...
let content = fs.readFileSync(config.fromFile, 'utf-8');
//去掉换行和空格
...
while (true) {
    ...
    let afterValue = beforeValue + (isX ? config.dx : config.dy);
...
fs.writeFileSync(config.toFile, newContent, 'utf-8');